const Footer1 = () => {
    return (
        <>
            <footer className="bg-[#4CAF50] text-white py-12 mt-8">
                <div className="container mx-auto px-6 lg:px-12 grid grid-cols-1 md:grid-cols-12 gap-8">
                    ...
                    <div className="md:col-span-4 flex flex-col items-start">
                        <div className="flex items-center space-x-3 mb-12">
                            ...
                            />
                            <div>
                                <h1 className="text-lg font-semibold">VerifyNG</h1>
                                <p className="text-sm italic">one verification for all...</p>
                            </div>
                        </div>
                    ...
                    <div className="md:col-span-2 flex flex-col space-y-4">
                        ...
                        <div>
                            <select
                                className="bg-[#4CAF50] text-white border border-white rounded mt-8 px-2 py-1 text-sm"
                            >
