    ...
    return (
        <section className="relative h-screen flex flex-col items-center justify-center text-center px-6 lg:px-12">
            ...
            <div className="max-w-4xl">
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#4C368C] mb-6 mt-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 rounded-full border border-[#4CAF50]] bg-white pl-2 mb-12">
                ...
                />
                <button className="bg-green-500 text-white border border-green-500 rounded-full px-6 py-2 cursor-pointer transition duration-300 ease-in-out hover:bg-transparent hover:text-green-500">
                    Join our waitlist
                </button>
            </div>
