...
const MainPage = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen font-sans">
            ...
            <div className="container mx-auto px-4 lg:px-12">
                ...
                <section className="px-6 lg:px-12 py-12 bg-white mt-8">
                    <div className="flex flex-col items-center text-center">
                        {/* Heading */}
                        <h2 className="text-3xl lg:text-5xl font-bold text-[#4C368C] mb-6">Wish to get in touch?</h2>
                        {/* Subtext */}
                        <p className="text-sm lg:text-base text-gray-600 mb-8">
                            Kindly reach out to us for any enquiries, partnership, or more.
                        </p>
                        {/* Button */}
                        <button className="bg-green-500 text-white px-6 py-3 rounded-full font-semibold cursor-pointer transition duration-300 hover:bg-green-600 mb-6">
                            Contact Us
                        </button>
                        {/* Image */}
                        <img
            ...
            <footer className="bg-[#39286A] text-white py-12">
